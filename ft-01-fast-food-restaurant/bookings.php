      ...
      <nav class="navbar navbar-expand-lg custom_nav-container ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="user_option">
            ...
            <!-- <a onclick="return confirm('Are you sure you want to delete this record?');" href="./delete-admin.php?id=<?php echo $r['id'] ?>" class="btn btn-danger">Delete</a> -->
            <!-- <a href="return <script>alert(\'You have to tick the box\')</script>;" class="user_link"> -->
            <a class="user_link">
              <!-- <i class="fa fa-user" onclick="NotYet()"  aria-hidden="false"></i> -->
...
<section class="food_section layout_padding-bottom">
  <div class="container">
    ...
    <!-- <div class="d-grid gap-12 d-md-block">
      <a href="#" class="btn btn-primary btn-lg enabled" tabindex="-1" role="button" aria-disabled="true">Primary link</a>
    ...
    <div class="heading_container heading_center">
      <h1>
        ...
        <div class="btn-group" center>
          <a href="?filter_id=0" class="btn btn-secondary  btn-lg  <?php echo $filter_id == 0 ? 'active' : ''; ?>" aria-current="page">*All</a>
          <a href="?filter_id=1" class="btn btn-secondary  btn-lg  <?php echo $filter_id == 1 ? 'active' : ''; ?>" aria-current="page">Burger</a>
          <a href="?filter_id=2" class="btn btn-secondary  btn-lg  <?php echo $filter_id == 2 ? 'active' : ''; ?>" aria-current="page">Pizza</a>
          <a href="?filter_id=3" class="btn btn-secondary  btn-lg  <?php echo $filter_id == 3 ? 'active' : ''; ?>" aria-current="page">Pasta</a>
          <a href="?filter_id=4" class="btn btn-secondary  btn-lg  <?php echo $filter_id == 4 ? 'active' : ''; ?>" aria-current="page">Fries</a>
      </h1>
    </div>
    ...
    <div class="filters-content">
      <div class="row grid">
        ...
        <?php
        $results_item = $item->getItemsByCategoryId($filter_id);
        ...
        <div class="detail-box">
          <div class="heading_container">
            <h2>
              ...
              <!-- <a id='about'>We Are <?php //echo $title_header; ?></a> -->
            </h2>
          </div>
            <!-- <a id='about'>We Are <?php //echo $title_header; ?></a> -->
        </div>
          ...
          <tbody>
            <?php while ($r = $results->fetch(PDO::FETCH_ASSOC)) { ?>
              <tr>
                ...
                <td><a class="btn btn-sm btn-primary" href="./delete.php?id=<?php echo $r['id'] ?>" disabled>Delete</a></td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
...
<!-- function NotYet() {
  echo <script>alert('NotYet...')</script>;
} -->