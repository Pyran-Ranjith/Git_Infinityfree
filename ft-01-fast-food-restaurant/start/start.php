...
<div class="col-lg-8 mx-auto p-4 py-md-5">
  ...
  <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
    ...
    <a href="" class="d-flex align-items-center text-body-emphasis text-decoration-none">
      ...
      <span id="boot-icon" class="bi bi-markdown-fill"  style="font-size: 30px; color:cyan"></span>



      <span class="fs-4">&nbsp;Mahi's Blog Main Page</span>

    </a>

    <!-- DONT DELETE THIS IS FYI

      <p><i class="bi-person" style="font-size: 24px;"></i></p>

    <p><i class="bi-person-circle" style="font-size: 24px; color: red;"></i></p>
  ...
  <!-- <div class="p-3 mb-2 bg-dark text-white"> -->
   ...
   <!-- <h1 class="text-body-emphasis">This small project is with Bootstrap, Php and MySql</h1> -->

   <h2 class="text-body-emphasis">Demo Application of a Simple Website </h2>

    <p class="fs-5 col-md-15">This is to show you how a CURD application look lik. CRUD means Create, Read, Update and Delete of records. </p>

    <p class="fs-5 col-md-15">Following web development techniques are used here.</p>
    ...
    <ul>
        ...
        <!-- <p class="fs-6 col-md-8">For evaluation please use followings;</p>

        <ul>

          <li><b>Userid:&nbsp;</b><?php echo $_SESSION['appuseremail'] ?></li>

          <li><b>Password:&nbsp;</b><?php echo $_SESSION['appuserpassword'] ?></li>

        </ul> -->

    <p class="fs-5 col-md-15">Please evaluate this application with your data and send me feed back. Thanak you.</p>
    <p class="fs-5 col-md-15"><div class="text-danger">WARNING !! Please do not Delete your OWN account, instead create new test admin and delete it.</div></p>
...
<h5><?php echo $_SESSION['adminname']; ?></h5>
      <a href="<?php echo $_SESSION['appuserstsrtpage'] ?>" class="btn btn-primary btn-lg px-4">Continue</a>
